...
namespace FX.Mobile.DeveloperTools.Managers
{
	public class TemplateManager
	{
		...
		{
			string fileContents = GetTemplate(ResourceName);
			return Replacements.Aggregate(fileContents, (current, replacement) => current.Replace(replacement.Pattern, replacement.Value));
		}
	}
}
